...
## 4. AI Model Policy (Critical - Highest Priority)

> [!WARNING]
> This is a core architectural policy. Violations are treated as terminal errors.

## 5. API Security & Credentials Policy

> [!WARNING]
> This is a core architectural policy. Violations are treated as terminal errors.

### 5.1 Identifiers vs. Secrets
...
### 5.2 Firebase API Key Best Practices
...
### 5.5 API Credentials Policy Compliance (Strict)
