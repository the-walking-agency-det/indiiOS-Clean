...
const RESPONSE_POLL_TIMEOUT_MS = 90000;
...
exports.telegramWebhook = functions
    .runWith({
    secrets: [secrets_1.telegramBotToken, secrets_1.telegramWebhookSecret],
    timeoutSeconds: 120,
    memory: "256MB",
})
    ...
    const secret = process.env.TELEGRAM_WEBHOOK_SECRET || (() => {
        try {
            return secrets_1.telegramWebhookSecret.value();
        }
        catch (_a) {
            return "";
        }
    ...
    if (!((_a = update.message) === null || _a === void 0 ? void 0 : _a.text) || !update.message.chat) {
...
async function handleLink(chatId, text, username) {
    ...
    // Check expiration
    const expiresAt = ((_b = (_a = codeData.expiresAt) === null || _a === void 0 ? void 0 : _a.toMillis) === null || _b === void 0 ? void 0 : _b.call(_a)) || 0;
 ...
 */
async function handleSetAgent(chatId, text) {
...
function getTelegramToken() {
    ...
    if (envKey && envKey.trim().length > 0)
        return envKey;
    try {
        const secret = secrets_1.telegramBotToken.value();
 ...
 */
async function pollForResponse(userId, commandId) {
    const db = admin.firestore();
