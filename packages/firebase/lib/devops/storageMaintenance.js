...
exports.flagVideosForArchival = exports.trackStorageQuotas = exports.cleanupOrphanedVideos = void 0;
 ...
 */
exports.cleanupOrphanedVideos = functions
    .region("us-west1")
    ...
    const configDoc = await admin.firestore()
        ...
        .get();
    const enableDeletion = ((_a = configDoc.data()) === null || _a === void 0 ? void 0 : _a.enableDeletion) === true;
    if (!enableDeletion) {
 ...
 */
exports.trackStorageQuotas = functions
    .region("us-west1")
    .runWith({ enforceAppCheck: process.env.SKIP_APP_CHECK !== 'true',
    timeoutSeconds: 540,
    memory: "1GB",
 ...
 */
exports.flagVideosForArchival = functions
    .region("us-west1")
    .runWith({ enforceAppCheck: process.env.SKIP_APP_CHECK !== 'true',
    timeoutSeconds: 540,
    memory: "512MB",
    ...
    try {
        ...
        for (const file of files) {
            const metadata = file.metadata;
            const generatedAt = (_a = metadata.metadata) === null || _a === void 0 ? void 0 : _a.generatedAt;
            // Skip files already flagged
            if (((_b = metadata.metadata) === null || _b === void 0 ? void 0 : _b.archiveEligible) === "true")
                continue;
            // Determine file age
            let fileDate = null;
            ...
            if (fileDate && fileDate < cutoffDate) {
                try {
                    await file.setMetadata({
                        metadata: Object.assign(Object.assign({}, metadata.metadata), { archiveEligible: "true", archiveFlaggedAt: new Date().toISOString() }),
                    });
                    flagged++;
                }
                catch (err) {
...
//# sourceMappingURL=storageMaintenance.js.map