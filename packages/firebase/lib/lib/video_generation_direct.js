...
exports.generateVideoDirect = generateVideoDirect;
...
async function generateVideoDirect(params) {
    ...
    try {
        ...
        // Aspect ratio
        const aspectRatio = options === null || options === void 0 ? void 0 : options.aspectRatio;
        ...
        if (rawDuration) {
            ...
            if (dur <= 4)
                ...
                dur = 6; // strictly 4, 6, or 8 for Veo 3.1
            else
                dur = 8;
            config.durationSeconds = dur;
        }
        // Person generation — Veo 3.1 supports allow_adult, allow_all
        if (options === null || options === void 0 ? void 0 : options.personGeneration) {
            config.personGeneration = options.personGeneration;
        }
        // Resolution — 720p, 1080p, 4k
        if ((options === null || options === void 0 ? void 0 : options.resolution) && ['720p', '1080p', '4k'].includes(options.resolution)) {
        ...
        const base64Data = (video === null || video === void 0 ? void 0 : video.bytesBase64Encoded) || (video === null || video === void 0 ? void 0 : video.videoBytes);
        if (base64Data) {
        ...
        if (!videoUrl && (video === null || video === void 0 ? void 0 : video.name)) {
        ...
        if (!videoUrl && (video === null || video === void 0 ? void 0 : video.uri)) {
        ...
        if (!videoUrl) {
            ...
            const safeOutputKeys = generatedVideos.map((v) => Object.keys((v === null || v === void 0 ? void 0 : v.video) || {}));
        ...
        await admin.firestore().collection("videoJobs").doc(jobId).set({
            ...
            output: {
                ...
                metadata: {
                    ...
                    fps: (options === null || options === void 0 ? void 0 : options.fps) || 24,
                    mime_type: "video/mp4",
...
//# sourceMappingURL=video_generation_direct.js.map