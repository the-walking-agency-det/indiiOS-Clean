...
description: Platinum-level UI/UX design guidelines for modern web applications with glassmorphism, micro-interactions, and accessibility.
version: 2.0.0
last_updated: 2026-02-06
---

# UI/UX Design Expert (Platinum Level)

**Comprehensive design system guidelines for indiiOS and modern web applications.**
...
|-----------|----------------|
| **Premium Feel** | Rich aesthetics, no generic colors |
| **Motion Design** | Micro-interactions on every state change |
| **Accessibility First** | WCAG 2.1 AA compliance minimum |
| **Mobile-First** | Touch targets, responsive layouts |
| **Dark Mode First** | Design for dark, adapt to light |

### 1.2 Visual Language

- **Glassmorphism:** Blur backgrounds, semi-transparent surfaces
- **Depth:** Subtle shadows, layered z-indices
- **Color:** Curated palettes, HSL-based tokens
- **Typography:** Modern fonts (Inter, Outfit, Roboto)
- **Motion:** `framer-motion` for all animations

---

## 2. Design Tokens (indiiOS)

### 2.1 Department Colors

```css
/* index.css - Department Tokens */
:root {
  /* Department Colors */
  --color-dept-royalties: #FFC107;     /* Finance - Gold */
  --color-dept-marketing: #E91E63;     /* Marketing - Pink */
  --color-dept-creative: #A855F7;      /* Creative - Purple */
  --color-dept-distribution: #2196F3;  /* Distribution - Blue */
  --color-dept-legal: #00BCD4;         /* Legal - Cyan */
  --color-dept-analytics: #4CAF50;     /* Analytics - Green */
