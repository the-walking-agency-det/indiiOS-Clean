...
export function BoardroomModule() {
    const { isBoardroomMode, activeAgents } = useStore(
        useShallow(state => ({
            ...
            >
                ...
                <div className="relative w-full max-w-4xl h-[70vh]">
                    ...
                    <div className="absolute inset-8 rounded-[100%] border border-white/10 bg-white/[0.02] backdrop-blur-3xl shadow-[0_0_80px_rgba(99,102,241,0.1)] flex items-center justify-center overflow-hidden">
                        ...
                        <div className="relative z-10 w-full h-full p-16 flex flex-col gap-6 overflow-y-auto custom-scrollbar items-center text-center">

                            {/* Placeholder internal dialogue */}
                            <motion.div
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                transition={{ delay: 0.4 }}
                                className="mt-auto flex flex-col items-center gap-2 max-w-lg"
                            >
